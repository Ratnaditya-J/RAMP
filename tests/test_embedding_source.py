...
EMBEDDING_SOURCE_PATH = Path("data/embedding_source/gpt_oss_20b_hidden_state_v0_1.json")
TAXONOMY_PATH = Path("data/taxonomy/ramp_taxonomy_v0_1.json")


def test_embedding_source_freezes_gpt_oss_20b_hidden_state_contract() -> None:
    source = json.loads(EMBEDDING_SOURCE_PATH.read_text(encoding="utf-8"))
    ...
    assert source["runtime"]["extraction_runtime_for_embeddings_and_activations"]
